...
var callback = function() {
  $("pre code").each(function(i, block) {
    ...
    $(
      '<span class="fa fa-copy btncopy" data-clipboard-target="#' +
        rand +
        '"></span>'
    ).insertBefore(ele);
    ...
    if ($(this).attr("download")) {
      $(
        '<span class="fa fa-download btndownload" data-file-ext="' +
          block +
  ...
  $(".btndownload").on("click", function() {
    let target = $(this).attr("data-clipboard-target");
    var filename = $(target).attr("download");
